...
class ProgressionManager:
    ...
    def update(self, current_time: float, enemy_manager, tank_red_list, tank_green_list) -> bool:
        self._recharge_missiles(current_time)
        return self._handle_level_complete(enemy_manager, tank_red_list, tank_green_list)
    ...
    def _handle_level_complete(self, enemy_manager, tank_red_list, tank_green_list) -> bool:
