...
TANK_BLUE_HIT_DAMAGE = 15
TANK_RED_KILL_POINTS = 200
TANK_GREEN_KILL_POINTS = 300
TANK_GREEN_KILL_POINTS_ALONE = 500
TANK_BLUE_KILL_POINTS = 400

ENEMY_SHOOT_COOLDOWN = 3.0
ENEMY_SHOOT_LEVEL_START = 4
TANK_BLUE_BURST_COUNT = 3
TANK_BLUE_BURST_DELAY = 0.2
TANK_RED_SHOOT_DAMAGE = 20
TANK_GREEN_SHOOT_DAMAGE = 40
TANK_BLUE_SHOOT_DAMAGE = 15
MAX_ENEMIES = 6
...
HELICOPTER_MAX_HP = 250
HELICOPTER_PLAYER_SHOT_DAMAGE = 25
HELICOPTER_PROJECTILE_DAMAGE = 15
...
HELICOPTER_SCROLL_DECEL_RATE = 60.0
...
BACKGROUND_IMAGES_LVL2 = [
    'assets/background_lvl2_A.png',
    'assets/background_lvl2_A.png',
]
PLAYER_SPRITES = {
