...
BOAT_COMPOSITE_PATH = "assets/FinalBoss_lvl1/FinalBoss.jpg"
SHEET_PATH = "assets/FinalBoss_lvl1/finalBoss_lvl1.jpg"
...
PROJECTILE_SEQUENCE_DIRS = [
    Path("assets/FinalBoss_lvl1/BoatProjectile"),
    Path("assets/FinalBoss_lvl1/BoatShot"),
]
...
def _remove_checker_background(surface: pygame.Surface) -> pygame.Surface:
    """Remove editor checkerboard background from FinalBoss.jpg via border flood-fill."""
...
def _remove_sheet_gray_background(surface: pygame.Surface, tolerance: int = 24) -> pygame.Surface:
    """Remove connected gray background from sprites extracted from finalBoss_lvl1.jpg."""
    result = surface.convert_alpha()
    width, height = result.get_size()
    rgb = pygame.surfarray.pixels3d(result)
    alpha = pygame.surfarray.pixels_alpha(result)
...
class FinalBossBoat(pygame.sprite.Sprite):
    ...
    def _get_fire_frames(cls) -> list[pygame.Surface]:
        ...
        canvas_size = (108, 300)
        # Centered at cannon tips from FinalBoss.jpg composite.
    ...
    def _animate(self) -> None:
        ...
        center = self.rect.center
        frame = self.base_frames[self.frame_index]
